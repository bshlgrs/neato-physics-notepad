...
class Triangle extends React.Component {
  render () {
    const { triangle, triangleId } = this.props;
    // debugger;
    // Variables
    ...
    return <div position="relative">
      <div style={{position: "absolute", top: "70px", left: "50px", fontSize: "24px"}}>
        {buckTexForVars[0] ? <BuckTex el={buckTexForVars[0]} /> : "H"}
      </div>
      <div style={{position: "absolute", top: "200px", left: "70px", fontSize: "24px"}}>
        {buckTexForVars[1] ? <BuckTex el={buckTexForVars[1]} /> : "A"}
      </div>
      <div style={{position: "absolute", top: "90px", left: "160px", fontSize: "24px"}}>
        {buckTexForVars[2] ? <BuckTex el={buckTexForVars[2]} /> : "O"}
      </div>
      <div style={{position: "absolute", top: "160px", left: "30px", fontSize: "24px"}}>
        {buckTexForVars[3] ? <BuckTex el={buckTexForVars[3]} /> : "θ"}
      </div>
      <div style={{position: "absolute", top: "25px", left: "130px", fontSize: "24px"}}>
