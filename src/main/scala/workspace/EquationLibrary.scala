...
////@JSExportTopLevel("Gem.DefaultLibrary")
//object DefaultLibrary extends EquationLibrary(Map(
...
//      RationalNumber(1, 2)
//    ),
//    "force_due_to_gravity" -> Equation.buildFaster("Force due to gravity", "F = m * g",
//      Map("F" -> ("Force", SiNewton), "g" -> ("Gravitational acceleration", Meter / Second / Second), "m" -> ("Mass", Kilogram))),
